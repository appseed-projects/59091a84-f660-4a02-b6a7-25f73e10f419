...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-23 18:50`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/59091a84-f660-4a02-b6a7-25f73e10f419.git
$ cd 59091a84-f660-4a02-b6a7-25f73e10f419
```
